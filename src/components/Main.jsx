...
function Main() {
  const { prop, setprop, result, showresult, loading, recentprop, onSent } =
    useContext(Context);
    ...
    <div className="flex flex-col gap-5">
      ...
      {!showresult ? (
        <div className="p-9 px-[15%] flex flex-col">
          <span className="text-gradient text-6xl font-medium">
            Hello, Aditya.
          </span>
          <span className="text-6xl font-medium text-gray-300">
        ...
        <div className="p-9 px-[15%] flex flex-col max-w-5xl">
          <div className="p-8 flex gap-5 items-center">
            <i className="fa-solid fa-user"></i> {recentprop}
          </div>
          {loading ? (
            <div className="flex p-6">
              <img src={geminiIcon} className="max-h-10" />
